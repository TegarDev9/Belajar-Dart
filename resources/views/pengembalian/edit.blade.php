...
<section>
    <div class="container mt-3">
        <div class="row">
            <div class="col-lg-8">
                <h3 class="mb-4">Edit Pengembalian</h3>
                <form action="{{ url('/updatepengembalian/' . $data->id_kembali ) }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" name="denda" class="form-control" placeholder="Masukkan Nama" value="{{$data->denda}}">
                    </div>
